...
public class JFormularioVerAsientos extends JFormularioBase {
	...
	private Integer cantidadDeAsientosPorFila = 0;

	public JFormularioVerAsientos(String nombreDeSala) {
